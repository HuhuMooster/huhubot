...
const Tracker = require("./modules/TrialTracker.js");
require("dotenv").config();


class HuhuBot extends Client {
  constructor (options) {
    super(options);

    // Here we load the config.js file that contains our token and our prefix values.
    this.config = require("./config.js");
    this.config.token = this.config.token || process.env.BOT_TOKEN;
    ...
    // create Items and Ninja objects
